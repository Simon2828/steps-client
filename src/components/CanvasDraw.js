...
export default class extends Component {
  ...
  undo = () => {
    if (this.startDrawIdx.length > 0) {
        ...
        console.log('this.startDrawIdx', this.startDrawIdx);
      this.linesArray.splice(
        this.startDrawIdx.pop()
      );
      console.log('this.startDrawIdx 2', this.startDrawIdx);
      console.log('this.linesArray 2', this.linesArray)
      this.redraw(true);
      return true;
    }
    return false;
  ...
  render() {
      console.log('here in CanvasDraw render')
    return (
      <canvas
        width={this.props.canvasWidth}
        height={this.props.canvasHeight}
